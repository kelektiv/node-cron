...
// JSON tests
it('should test all json params', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "08", "hour": "15", "minute": "15","dayOfWeek": "6"}'
		);
	}).not.toThrow();
});

it('should test hyphens in jsonparams', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "0-15", "hour": "12-16", "minute": "*","dayOfWeek": "*"}'
		).not.to.throw();
	});
});
it('should test all hyphens in json params', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "0-15", "hour": "12-16", "minute": "5-15","dayOfWeek": "1-3", "month": "1-5"}'
		).not.to.throw();
	});
});
it('should test intervals in json params', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "*/5", "hour": "16", "minute": "*","dayOfWeek": "*"}'
		).not.to.throw();
	});
});
it('should test aliases in json params', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "08", "hour": "12", "dayOfWeek": "fri", "month":"jan"}'
		).not.to.throw();
	});
});
it('should test multiple aliases in one json field', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "08", "hour": "12", "dayOfWeek": "fri,thu", "month":"jan,dec"}'
		).not.to.throw();
	});
});
it('should test all commas in json params', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "8,15,16", "hour": "12,13,14", "dayOfWeek": "fri,thu,mon", "month":"jan,dec,nov"}'
		).not.to.throw();
	});
});
it('should give default params', function() {
	expect(function() {
		new cron.CronTime('{}').not.to.throw();
	});
});
it('should ignore not supported params in json', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "08", "error": "12", "error2": "15", "dayOfWeek": "fri", "month":"jan"}'
		).not.to.throw();
	});
});
it('should test out of bounds', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "62", "dayOfWeek": "fri", "month":"jan"}'
		).not.to.throw();
	});
});
it('should test a combination of hyphens, aliases and commas', function() {
	expect(function() {
		new cron.CronTime(
			'{"second": "30", "dayOfWeek": "fri,thu,1", "month":"jan,4,5"}'
		).not.to.throw();
	});
});
